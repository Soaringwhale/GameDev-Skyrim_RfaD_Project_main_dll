...
class RfadWidget : public RE::IMenu
{
  public:
    ...
    static constexpr std::string_view TRUE_HUD = "TrueHUD";       // говорят райт почти ничего не использует из трухуда, только одну желтую полоску, а так есть api трухуда на гите
	...
	static void off();
	static void on();   // show and toggle vis
